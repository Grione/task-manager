...
const createTaskTemplate = (task) => {
	...
	const isExpired = dueDate instanceof Date && isOverdueDate(dueDate, new Date()); // сравниваем дату погашения с текущей датой
	const isDateShowing = !!dueDate; // возврашаем boolean значение
